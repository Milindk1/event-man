    ...
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <p>The Department of CSE will create high quality professionals in Computer Science & Engineering and to
            foster leading edge research and to equip students to succeed and contribute to industry and society.</p>
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
            <li class="ftco-animate"><a href="https://www.youtube.com/@Manipalblog"><span
                  class="icon-youtube"></span></a></li>
            <li class="ftco-animate"><a href="https://www.facebook.com/mahemanipal/"><span
                  class="icon-facebook"></span></a></li>
            <li class="ftco-animate"><a href="https://www.instagram.com/mahe_manipal/?hl=en"><span
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker"></span><span class="text"> IC - 304
                  MIT Manipal, Eshwar Nagar, Udupi, Karnataka - 57104, India. </span></li>
              <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 8123357221</span></a></li>
              <li><a href="#"><span class="icon icon-envelope"></span><span
                    class="text">techtatva2k23@gmail.com</span></a></li>
            </ul>
          </div>
        </div>
      </div>
