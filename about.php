          ...
          <div class="col-md-12 d-flex align-items-center">
            ...
            <div class="tab-content ftco-animate" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel"
                ...
                <div>
                  <h2 class="mb-4">What is Techtatva? </h2>
                  <p>MIT Manipal's national-level annual technical fest, TechTatva, is a platform for young, innovative
                    minds across the country to present themselves. With the theme 'Encircling Creations Where the
                    Elements Collide,' TechTatva'23 explores how we have sustained the resources provided by the four
                    elements of nature, bringing about some positive change in our society.</p>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <a class="card-link" data-toggle="collapse" href="#menu3" aria-expanded="false" aria-controls="menu3">
                    Bookmarksgrove, the headline? <span class="collapsed"><i class="icon-plus-circle"></i></span><span
